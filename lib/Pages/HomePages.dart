...
import 'package:flutter_application_3/Widgets/Vaigiotoi.dart';
import 'package:flutter_application_3/Widgets/Vaingaytoi.dart';
...
class _HomePageState extends State<HomePage>{
 ...
 ScrollController _scrollController = ScrollController();
  ...
  void solieu() async {
    ...
    DateTime dateTime_1_ngay_toi = DateTime.fromMillisecondsSinceEpoch(maso_time_1_ngay_toi * 1000);
    ...
    DateTime dateTime_2_ngay_toi = DateTime.fromMillisecondsSinceEpoch(maso_time_2_ngay_toi * 1000);
    ...
    DateTime dateTime_3_ngay_toi = DateTime.fromMillisecondsSinceEpoch(maso_time_3_ngay_toi * 1000);
    ...
    DateTime dateTime_4_ngay_toi = DateTime.fromMillisecondsSinceEpoch(maso_time_4_ngay_toi * 1000);
    ...
    DateTime dateTime_5_ngay_toi = DateTime.fromMillisecondsSinceEpoch(maso_time_5_ngay_toi * 1000);
    ...
    DateTime dateTime_6_ngay_toi = DateTime.fromMillisecondsSinceEpoch(maso_time_6_ngay_toi * 1000);
    ...
    DateTime dateTime_7_ngay_toi = DateTime.fromMillisecondsSinceEpoch(maso_time_7_ngay_toi * 1000);
    ...
    DateTime dateTime_1_gio_toi = DateTime.fromMillisecondsSinceEpoch(maso_time_1_gio_toi * 1000);
    ...
    DateTime dateTime_2_gio_toi = DateTime.fromMillisecondsSinceEpoch(maso_time_2_gio_toi * 1000);
    ...
    DateTime dateTime_3_gio_toi = DateTime.fromMillisecondsSinceEpoch(maso_time_3_gio_toi * 1000);
    ...
    DateTime dateTime_4_gio_toi = DateTime.fromMillisecondsSinceEpoch(maso_time_4_gio_toi * 1000);
    ...
    DateTime dateTime_5_gio_toi = DateTime.fromMillisecondsSinceEpoch(maso_time_5_gio_toi * 1000);
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          hintText: "Địa điểm mà bạn muốn xem dự báo thời tiết? $diachi",
      ...
      drawer: DrawerWidget(),
       ...
       floatingActionButton: FloatingActionButton(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(12), // Điều chỉnh giá trị để thay đổi hình dáng
        ),
      ),
